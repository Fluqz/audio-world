...
exports.notes = exports.CUSTOM_SCALE = exports.BLUES_9NOTE_SCALE = exports.HEPTATONIC_SCALE = exports.HEXATONIC_SCALE = exports.MINOR_PENTATONIC_SCALE = exports.HIRAJOSHI_SCALE = exports.PENTATONIC_SCALE = exports.LOKRIAN_SCALE = exports.AEOLIAN_SCALE = exports.MYXOLYDIAN_SCALE = exports.LYDIAN_SCALE = exports.PHRYGIAN_SCALE = exports.DORIAN_SCALE = exports.IONIAN_SCALE = exports.pitchNote = exports.getScale = exports.getNote = void 0;
/** Returns a Note by name = [Note + Octave] = C3, C#0, .. */
const getNote = (note) => {
    for (let n of exports.notes) {
        if (n.note === note)
            return n;
    }
    return null;
...
const getScale = (prime, scale) => {
    const i = exports.notes.indexOf(prime);
    if (i == -1)
        return null;
    const ns = [];
    ns.push(prime);
...
const pitchNote = (note, pitch) => {
    note.frequency += pitch;
    return note;
};
exports.pitchNote = pitchNote;
/** Prime, Sekunde, Terz, Quarte, Quinte, Sexte, Septime, Oktave, */
/** Major Scale */
exports.IONIAN_SCALE = [2, 2, 1, 2, 2, 2, 1];
exports.DORIAN_SCALE = [2, 1, 2, 2, 2, 1, 2];
exports.PHRYGIAN_SCALE = [1, 2, 2, 2, 1, 2, 2];
exports.LYDIAN_SCALE = [2, 2, 2, 1, 2, 2, 1];
exports.MYXOLYDIAN_SCALE = [2, 2, 1, 2, 2, 1, 2];
exports.AEOLIAN_SCALE = [2, 1, 2, 2, 1, 2, 2];
exports.LOKRIAN_SCALE = [1, 2, 2, 1, 2, 2, 2];
exports.PENTATONIC_SCALE = [2, 3, 3, 2, 3];
exports.HIRAJOSHI_SCALE = [2, 1, 4, 1, 4];
/** 5 Note blues scale */
exports.MINOR_PENTATONIC_SCALE = [3, 2, 2, 3, 2];
/** 6 Note blues scale */
exports.HEXATONIC_SCALE = [3, 2, 1, 1, 3, 2];
/** 7 Note blues scale */
exports.HEPTATONIC_SCALE = [2, 1, 2, 1, 3, 1, 2];
/** 9 Note blues scale */
exports.BLUES_9NOTE_SCALE = [2, 1, 1, 1, 2, 2, 1, 1, 1];
exports.CUSTOM_SCALE = [3, 4, 1, 2];
...
//# sourceMappingURL=note-frequencies.js.map